...
-- at runtime using the environment variable data_interval_bindir.
...
-- environment variable data_interval_libdir.
...
-- using the environment variable data_interval_dynlibdir.
...
-- runtime using the environment variable data_interval_datadir.
...
-- variable data_interval_libexedir.
...
-- using the environment variable data_interval_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3/data-interval-2.1.2-inplace-test-interval"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.14.1-c6c3/data-interval-2.1.2"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.14.1-c6c3/data-interval-2.1.2"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "data_interval_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "data_interval_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "data_interval_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "data_interval_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "data_interval_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "data_interval_sysconfdir") (\_ -> return sysconfdir)
